...
\section{Modularização Funcional e Resolução das queries}
    ...
    contagem fosse eficiente. Com isto o unico trabalho necessário foi obter as
    \textbf{tags} das \textbf{quetões} dos \textbf{utilizadores} com melhor
    reputação (\textbf{1}). Depois abtemos a lista ordenada por ocorrencia das
    tags e atravez de \textbf{2} obtemos os ids das mesmas.
