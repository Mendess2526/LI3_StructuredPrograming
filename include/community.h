 ...
 */
USERS community_get_sorted_user_list(TAD_community com,
                                     ComCmpFunc cfunc,
                                     int N);
 ...
 */
ANSWERS community_get_sorted_answer_list(TAD_community com,
                                         DATETIME from,
                                         DATETIME to,
                                         ComCmpFunc func,
                                         int N);
 ...
 */
void community_iterate_questions(TAD_community com,
                                 DATETIME from,
                                 DATETIME to,
                                 void* data,
                                 CalFunc calFunc);
 ...
 */
void community_iterate_answers(TAD_community com,
                               DATETIME from,
                               DATETIME to,
                               void* data,
                               CalFunc calFunc);
